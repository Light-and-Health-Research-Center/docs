  ...
  return (
    <div className="w-full lg:w-1/3-4gap mb-4">
      <Link href={menuObj.link}>
        <a className="text-cetaceanBlue-100 hover:underline focus:outline-none focus-visible:underline active:text-cetaceanBlue-80 focus:text-cetaceanBlue-100">
          <h6 className="mb-2 ">{menuObj.title}</h6>
        </a>
      </Link>
