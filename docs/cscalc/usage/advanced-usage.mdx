...
desc: "ALL of the more nuanced, yet powerful features of the CS Calculator 2.0."
---
...
For the times when you want to save your custom sources from the CS Calculator 2.0, and not have to manually input them each time you revisit the site, you can download your sources.
...
2. Save the file from the download window that pops up.
    <AlertBox><b>Tip:</b> This popup window might look slightly different depending on the browser you are using.</AlertBox>
      ...
      Here is an example of the structure of the resulting file. This is an example of a JSON file containg **two** sources: a warm source, and a cool source.
      ...
      <AlertBox><b>Tip:</b> If the resulting <b>Source</b> object in the downloaded JSON file is empty, check to make sure you've added 1 or more custom sources.</AlertBox>
...
Once you've downloaded your custom sources as JSON, you are able to upload those sources back into the calculator, without the hassle of manual input.
...
4. If the files you uploaded were valid, you will see your custom sources appear in the **Source List** panel, and automically be added to the **Selected Sources** panel.
  <Img
...
Editing a custom source from within the CS Calculator 2.0 can be helpful so that you don't have to upload an entirely new source everytime you want to make a change.
...
2. Adjust any input fields in the **Edit Custom Source** modal that appears and click **Edit Source**. This input fields are the same as when <DocLink href="#add-custom-source">adding a custom source</DocLink>.
  <Img
...
2. Save the file from the download window that pops up.
  <AlertBox><b>Tip:</b> This wpopup window might look slightly different depending on the browser you are using.</AlertBox>
  <Img
...
Downloading the combined SPD's as text can be helpful in translating them into your own work, such as copy and pasting them into a Microsoft Excel spreadsheet.

1. Click the **Download Combined SPD's as Text** icon in the **Combined Source SPD's** panel.
  <Img
...
In the case that you want to experiment with the CS Calculator 2.0 data in your own programmatic work, we allow you to download all the calculation data into a single JSON file.
